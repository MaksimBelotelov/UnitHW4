...
class PaymentFormTest {
    ...
    @Test
    public void methodPayWillCallChargeMethod() {
        CreditCard creditCard = mock(CreditCard.class);

        when(creditCard.getCardNumber()).thenReturn("123456");
        when(creditCard.getCardHolder()).thenReturn("Ivan Ivanov");
        when(creditCard.getExpiryDate()).thenReturn("2022-02-02");
